...
const socialLinks = [
  { label: "GitHub", href: "https://github.com/Abrahamalejolowo", icon: Github },
  { label: "LinkedIn", href: "https://linkedin.com/in/abraham-alejolowo-b7ab97319", icon: Linkedin },
]
          ...
          <div className="hidden items-center gap-1 md:flex">
            {navItems.map((item, index) => (
              <button
                ...
                className={cn(
                  "relative px-4 py-2.5 font-mono text-xs uppercase tracking-widest transition-all duration-300 rounded-lg cursor-pointer",
                  isActive(item.href)
                    ? "text-primary"
          ...
          <div className="flex flex-col gap-1 border-t border-border/50 pt-4">
            {navItems.map((item, index) => (
              <button
                ...
                className="flex items-center gap-3 rounded-lg px-4 py-3.5 font-mono text-sm uppercase tracking-widest text-muted-foreground transition-all duration-200 active:bg-secondary hover:text-foreground hover:bg-secondary/50 w-full text-left"
